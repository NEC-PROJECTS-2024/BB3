...
#Rechecking after removing url column
df.columns.tolist()
...
print("Matthews_Correlation_Coefficient --->",Matthews_Correlation_Coefficient)
...
for i in range(0, K):
    ...
    print(classification_report(Y_test_list[i], rf_predictions))
    ...
    print(classification_report(Y_test_list[i], dt_predictions))
    ...
    print(classification_report(Y_test_list[i], svm_predictions))
    ...
    print(classification_report(Y_test_list[i], ab_predictions))
    ...
    print(classification_report(Y_test_list[i], nb_predictions))
    ...
    print(classification_report(Y_test_list[i], nn_predictions))
    ...
    print(classification_report(Y_test_list[i], kn_predictions))
